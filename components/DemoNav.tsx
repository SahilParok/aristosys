...
export default function DemoNav() {
  const p = usePathname();
  return (
    <nav style={{ padding: '14px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(184,151,90,0.2)', background: 'rgba(10,15,26,0.97)', position: 'sticky', top: 0, zIndex: 50 }}>
