...
export default function LandingPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0a0f1a' }}>
      {/* Nav */}
      <nav style={{ padding: '20px 60px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(184, 151, 90, 0.2)' }}>
      ...
      {/* Hero */}
      <main style={{ padding: '80px 60px 60px', maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{
        ...
        <h1 style={{ fontSize: '54px', fontWeight: '800', color: 'white', lineHeight: '1.15', marginBottom: '20px', letterSpacing: '-1px' }}>
          AI-Powered<br />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px', marginBottom: '60px' }}>
          {STATS.map(s => (
            <div key={s.label} style={{ padding: '24px', background: 'rgba(184, 151, 90, 0.08)', borderRadius: '12px', border: '1px solid rgba(184, 151, 90, 0.2)' }}>
              <div style={{ fontSize: '32px', fontWeight: '800', background: 'linear-gradient(135deg, #b8975a, #d4af37)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{s.value}</div>
        ...
        {/* Features */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginBottom: '60px', textAlign: 'left' }}>
          {FEATURES.map(f => (
